...
public class CLSVendedoresJDBC {
    ...
    private static final String SQL_DELETE="delete from tb_progracomision where codigo=";
    private static final String SQL_UPDATE="update tb_progracomision set nombre=?,enero=?,febrero=?,marzo=? where codigo=?;";
    
    public List<MdVendedores> SeleccionarTodalaInfo(){
        Connection conexion=null;
        PreparedStatement statement=null;
        ResultSet resultSet=null;
        MdVendedores MV=null;
        List<MdVendedores> Comisiones= new  ArrayList<MdVendedores>();
    ...
    public int InsertarVendedor(MdVendedores vendedor){
        int rows=0;
        Connection conexion=null;
        PreparedStatement statement=null;
        try {
    ...
    public String BusquedadeInfo(Double busqueda){
        ...
        ResultSet resultSet=null;
        MdVendedores MV=null;
        List<MdVendedores> Busqueda= new  ArrayList<MdVendedores>();
